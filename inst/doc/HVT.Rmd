...
7. <a href="https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/Implementation_of_tsne_umap_in_trainHVT.html" target="_blank">**Dynamic Forecasting of Macroeconomic Time Series Dataset using HVT (Created at: 12-Nov-2024):**</a> Contains enhancements to the HVT package for dynamic forecasting using Monte Carlo Simulations of Markov Chain (MSM) on macroeconomic time series dataset. 
