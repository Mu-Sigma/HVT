...
author: "Zubin Dowlaty, Shubhra Prakash, Sangeet Moy Das, Shantanu Vaidya, Praditi Shah, Srinivasan Sudarsanam, Somya Shambhawi,Chepuri Gopi Krishna, Siddharth Shorya, Pon Anureka Seenivasan, Vishwavani, Bidesh Ghosh, Alimpan Dey"
...
vignette_data <- data.frame(
  Version_Number = c("v18.05.17", "v18.05.17", "v23.05.16", "v23.10.26", "v24.05.16","v24.08.14", "v24.11.12"),
  Vignette_Title = c(
...
kable(vignette_data, format = "html", 
      col.names = c("Version Number", "Vignette Title", "Description"), 
