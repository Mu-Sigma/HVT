...
vignette_data <- data.frame(
  ...
  "<a href='https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/Experimentation_of_hyperparameters_in_msm.html' target='_blank'>Experimentation of Hyperparameters to find best model in msm Dynamic Forecasting</a>"
),
  Description = c(
    ...
    "Includes enhancements to the HVT package for selecting the best model (based on lowest MAE) in MSM ex-post forecasting."
  ),
