...
2.  **Data Projection**: Dimension projection of the compressed cells to 2D with t-SNE, UMAP and Sammon's Mapping Algorithm. This step creates a topology preserving map (also called as <a href="https://en.wikipedia.org/wiki/Embedding" target="_blank"> embeddings</a>) coordinates into the desired output dimension.
