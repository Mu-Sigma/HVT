...
- Initial timestamp: `r format(max(temporal_train$Date), "%Y-%m-%d")`
...
The Ex-post forecasting will range from `r format(min(test_dataset$Date), "%Y-%m-%d")` to `r format(max(test_dataset$Date), "%Y-%m-%d")` as per the selected test period.
