...
vignette_data <- data.frame(
  ...
  "<a href='https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/Dynamic_Forecasting_macroeconomic_data.html' target='_blank'>Experimentation of Hyperparameters to find best model in msm Dynamic Forecasting</a>"
),
  Description = c(
