...
list.of.packages <- c("dplyr", "kableExtra", "geozoo", "plotly", "purrr", "DT", "HVT")
...
```{r level one sample data,warning=FALSE,message=FALSE,results='hide'}
...
showing just top 20 rows for the sake of brevity.
...
* **`cell_id`** - A logical indicating whether the cell IDs should be displayed. Default is TRUE.

* **`cell_id_position`** - A character indicating the position of the cell IDs. Accepted entries are 'top',  'bottom', 'left', 'right', and 'center'. Default is 'bottom'.

* **`centroids`** - A logical indicating whether the centroid points should be displayed. Default value is TRUE. 

* **`cell_id_size`** - A numeric value indicating the size of the cell IDs. Default is 4

* **`centroid.size`** - A numeric value or vector indicating the size of centroids for each level. Default is 0.8
