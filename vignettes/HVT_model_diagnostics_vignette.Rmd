...
list.of.packages <- c("dplyr", "kableExtra", "geozoo", "plotly", "purrr", "HVT", "DT")
...
```{r level one sample data,warning=FALSE,message=FALSE,echo=TRUE,class.source = 'fold-show', results='hide'}
...
```{r scoreHVT2 hotel,warning=FALSE,message=FALSE}
