...
* __`plot_type`__ - A Character to indicate what type of plot should be generated. Accepred entries are "static" (ggplot object) or "interactive"(plotly object). Default is "static".
...
The plots below are static ggplot objects. To interactively view each dot with its corresponding timestamp and values, set `plot_type = "interactive"` to generate Plotly objects.
