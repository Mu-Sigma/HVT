...
# Load required packages from local installation only
# Note: All packages must be installed locally - no CRAN downloads
...
# Load packages (assumes they are already installed locally)
invisible(lapply(list.of.packages, library, character.only = TRUE))
```

```{r setup-working-directory, echo=FALSE, eval=TRUE}
# Set working directory to vignettes folder if not already there
# This ensures relative paths work correctly when knitting
if (basename(getwd()) != "vignettes") {
  vignettes_dir <- file.path(getwd(), "vignettes")
...
if (!file.exists(csv_path)) {
  csv_path <- "/home/shailu/Desktop/HVT/vignettes/sample_dataset/macro_eco_data_2025.csv"
}
...
- Train period: from 1999-12-01 to 2024-09-01

- Test Period/Ex-Post forecasting: from 2024-10-01 to 2025-09-01
