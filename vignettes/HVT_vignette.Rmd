...
```{r torus hvt first,warning=FALSE,fig.show='hold',message=FALSE, results='hide'}
hvt.torus <- trainHVT(
  torus_train,
  n_cells = 100,
  depth = 1,
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 4: Sammons 1D x Cell ID plot for layer 1 shown for the 100 cells in the torus training dataset' ,fig.align='center'}
...
```{r torus hvt second,warning=FALSE,fig.show='hold',message=FALSE, results='hide'}
hvt.torus2 <- trainHVT(
  torus_train,
  n_cells = 300,
  depth = 1,
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 5: Sammons 1D x Cell ID plot for layer 1 shown for the 300 cells in the torus training dataset',out.width="100%", out.height="60%", fig.align='center'}
...
```{r torus hvt third ,warning=FALSE,fig.show='hold',message=FALSE, results='hide'}
hvt.torus3 <- trainHVT(
  torus_train,
  n_cells = 500,
  depth = 1,
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 6: Sammons 1D x Cell ID plot for layer 1 shown for the 500 cells in the torus training dataset',out.width="100%", out.height="60%", fig.align='center'}
...
plotHVT <-(hvt.results,line.width,color.vec, 
           centroids,centroid.size, centroid.color, 
...
* __`cell_id_position`__ - (2Dhvt/2Dheatmap) A Character indicating the position of the cell ID text. Only applicable for the level 1. Accepted entries are 'top', 'left', 'bottom', 'right' or 'center'. (default = 'bottom')

* __`centroids`__ - (2Dhvt/2Dheatmap) A logical option indicating whether the centroids have to be plotted or can be skipped. Default is TRUE.
...
```{r, warning=FALSE,message=FALSE, fig.cap='Figure 7: Sammons 2D Plot for 100 cells',  fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r, message=FALSE,warning=FALSE,fig.cap='Figure 8: Sammons 2D Plot for 300 cells',  fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 9: Sammons 2D Plot for 500 cells',  fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 10: The Voronoi tessellation for layer 1 shown for the 100 cells in the torus training dataset', fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 11: The Voronoi tessellation for layer 1 shown for the 300 cells in the torus training dataset', fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 12: The Voronoi tessellation for layer 1 shown for the 500 cells in the torus training dataset', fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r hmp level two quantization torus n demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 13: The Voronoi tessellation for layer 1 and number of cells 500 with the heat map overlaid for `No. of entities in each cell` in the torus dataset', fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.torus3,hmap.cols = "n",plot.type = '2Dheatmap')
```

```{r hmp level two quantization torus x demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 14: The Voronoi tessellation for layer 1 and number of cells 500 with the heat map overlaid for variable `x` in the torus dataset', fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.torus3,hmap.cols = "x",plot.type = '2Dheatmap')
```

```{r hmp level two quantization torus y demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 15: The Voronoi tessellation for layer 1 and number of cells 500 with the heat map overlaid for variable `y` in the torus dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.torus3,hmap.cols = "y",plot.type = '2Dheatmap')
```

```{r hmp level two quantization torus z demo,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 16: The Voronoi tessellation for layer 1 and number of cells 500 with the heat map overlaid for variable `z` in the torus dataset', fig.width = 7, fig.height = 5, fig.align='center'}
...
scoreHVT(dataset,hvt.results.model,child.level,
         mad.threshold,line.width,color.vec,
         normalize,distance_metric,error_metric,
         yVar,analysis.plots,names.column,
         centroids,cell_id, cell_id_size, 
         cell_id_position, centroid.size)
```
...
*Parameters used for the scored Plotly visualization, generated only when analysis.plots = TRUE*

* __`cell_id`__ - A logical indicating whether the cell IDs should be displayed. Default is TRUE.

* __`cell_id_position`__ - A character indicating the position of the cell IDs. Accepted entries are 'top',  'bottom', 'left', 'right', and 'center'. Default is 'bottom'.

* __`centroids`__ - A logical indicating whether the centroid points should be displayed. Default value is TRUE. 

* __`cell_id_size`__ - A numeric value indicating the size of the cell IDs. Default is 4

* __`centroid.size`__ - A numeric value or vector indicating the size of centroids for each level. Default is 0.8
...
```{r scoreHVT torus,warning=FALSE,message=FALSE, results='asis'}
scoring_torus <- scoreHVT(torus_test, hvt.torus3, normalize = FALSE)
```

```{r}
summary(scoring_torus)
```


```{r, warning=FALSE,message=FALSE,fig.cap='Figure 17: Mean Absolute Difference', fig.width=7, fig.height=5, fig.align='center'}
...
```{r data structure computer,warning=FALSE,message=FALSE}
str(computers)
```
...
```{r train-test computer,warning=FALSE,message=FALSE}
...
```{r train computers structure, warning=FALSE}
...
```{r computers structure, warning=FALSE}
...
```{r level one computers,warning=FALSE,message=FALSE, results='hide'}
...
__`hvt.results[[3]]`__ gives us detailed information about the compressed data.
...
```{r summary level one computers,warning=FALSE}
...
```{r, warning=FALSE,message=FALSE,fig.cap='Figure 19: Sammons 2D Plot for 300 cells', fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r plot level one computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 20: The Voronoi Tessellation for layer 1 shown for the 300 cells in the dataset ’computers’',  fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r hmp level one n computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 21: The Voronoi Tessellation with the heat map overlaid over the `No. of entities in each cell` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.results,hmap.cols = "n",plot.type = '2Dheatmap')
```

```{r hmp level one price computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 22: The Voronoi Tessellation with the heat map overlaid over the variable `price` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.results,hmap.cols = "price",plot.type = '2Dheatmap')
```

```{r hmp level one hd computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 23: The Voronoi Tessellation with the heat map overlaid over the variable `hd` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.results,hmap.cols = "hd",plot.type = '2Dheatmap')
```

```{r hmp level one ram computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 24: The Voronoi Tessellation with the heat map overlaid over the variable `ram` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.results, hmap.cols = "ram",plot.type = '2Dheatmap')
```

```{r hmp level one screen computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 25: The Voronoi Tessellation with the heat map overlaid over the variable `screen` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
plotHVT(hvt.results, hmap.cols = "screen",plot.type = '2Dheatmap')
```

```{r hmp level one ads computers,warning=FALSE,fig.show='hold',results='hide',message=FALSE,fig.cap='Figure 26: The Voronoi Tessellation with the heat map overlaid over the variable `ads` in the ’computers’ dataset',  fig.width = 7, fig.height = 5, fig.align='center'}
...
```{r scoreHVT hmap computers,warning=FALSE,message=FALSE, results='asis'}
...
```{r}
summary(scoring_comp)
```


```{r,message=FALSE,warning=FALSE,fig.cap='Figure 27: Mean Absolute Difference', fig.width=7, fig.height=5, fig.align='center'}
