...
| v25.08.25 | [Experimentation of Hyperparameters to find best model in msm Dynamic Forecasting](https://nbviewer.org/github/Mu-Sigma/HVT/blob/master/vignettes/Experimentation_of_hyperparameters_in_msm.html) | Includes enhancements to the HVT package for selecting the best model (based on lowest MAE) in MSM ex-post forecasting. |
